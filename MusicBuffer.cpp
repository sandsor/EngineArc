...
void MusicBuffer::SetPosition(float x, float y, float z)
{
	alSource3f(p_Source, AL_POSITION, x, y, z);
}

void MusicBuffer::LoopSound(bool loop)
{
...
MusicBuffer::MusicBuffer(VisualObject* AttachTo, const char* filename)
{
	Construct(filename);
	AttachAudioToObject(AttachTo);
}

void MusicBuffer::AttachAudioToObject(VisualObject* AttachTo)
{
	m_AttachTo = AttachTo;
}

void MusicBuffer::Construct(const char* filename)
{
